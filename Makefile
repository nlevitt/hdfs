HADOOP_COMMON_PROTOS = $(shell find v2/protocol/hadoop_common -name '*.proto')
HADOOP_HDFS_PROTOS = $(shell find v2/protocol/hadoop_hdfs -name '*.proto')
...
PROTO_MAPPING = MSecurity.proto=github.com/colinmarc/hdfs/v2/protocol/hadoop_common
...
%.pb.go: $(HADOOP_HDFS_PROTOS) $(HADOOP_COMMON_PROTOS)
	protoc --go_out='$(PROTO_MAPPING):v2/protocol/hadoop_common' -Iv2/protocol/hadoop_common -Iv2/protocol/hadoop_hdfs $(HADOOP_COMMON_PROTOS)
	protoc --go_out='$(PROTO_MAPPING):v2/protocol/hadoop_hdfs' -Iv2/protocol/hadoop_common -Iv2/protocol/hadoop_hdfs $(HADOOP_HDFS_PROTOS)
